...
return false;}})();;CloudflareApps.installs["Rd1pguc00X-8"]={appId:"kT4AKs7IySDL",scope:{}};;CloudflareApps.installs["Rd1pguc00X-8"].options={"site":"109898","user":"0"};;CloudflareApps.installs["Rd1pguc00X-8"].product={"id":"free-legacy"};;if(CloudflareApps.matchPage(CloudflareApps.installs['Rd1pguc00X-8'].URLPatterns)){(function(){'use strict';let a=window;let b=document;var options=CloudflareApps.installs['Rd1pguc00X-8'].options;if(!options.site){return;}
