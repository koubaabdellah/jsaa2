...
function OptanonWrapper() {
    ...
    try {
        ...
        if (ctm.gdpr.owCount === 0) {
            ...
            var ftCkLink = document.querySelector("footer #privacy-manager") || (document.querySelector('cdc-footer') && document.querySelector('cdc-footer').renderRoot && document.querySelector('cdc-footer').renderRoot.querySelector('#privacy-manager'));
