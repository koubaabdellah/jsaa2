...
(function($){'use strict';Drupal.behaviors.infiniteBibblioRelated={attach:function(context,settings){var current_nid=settings.penton_bibblio_api.current_nid,recommendation_key=settings.penton_bibblio_api.recommendation_key,style_classes=settings.penton_bibblio_api.style_classes,style_classes_mobile=settings.penton_bibblio_api.style_classes_mobile,content_item_id=settings.penton_bibblio_api.content_item_id,default_catalogue_id=settings.penton_bibblio_api.default_catalogue_id,sponsored_catalogue_id=settings.penton_bibblio_api.sponsored_catalogue_id,query_string_params_related=settings.penton_bibblio_api.query_string_params_related,query_string_params_sponsored=settings.penton_bibblio_api.query_string_params_sponsored,query_string_params_related_mobile=settings.penton_bibblio_api.query_string_params_related_mobile,query_string_params_sponsored_mobile=settings.penton_bibblio_api.query_string_params_sponsored_mobile,recommendation_type=settings.penton_bibblio_api.recommendation_type,subtitle_field=settings.penton_bibblio_api.subtitle_field,date_format=settings.penton_bibblio_api.date_format,disable_token=settings.penton_bibblio_api.disable_token;if(content_item_id&&content_item_id!=disable_token){var related={targetElementId:"bib_related-content-"+current_nid,recommendationKey:recommendation_key,contentItemId:content_item_id,autoIngestion:false,catalogueIds:[default_catalogue_id]};if(query_string_params_related.length!==0){var params=JSON.parse(query_string_params_related);for(var key in params){var param=params[key];if(param.indexOf('gtm_datalayer')>=0){var pars=param.split(".");if(pars.length==4){if(pars[3]=='scrollPosition'){var currElem='article.article-'+current_nid;if($(currElem).prev().length==0){params[key]=gtm_datalayer[pars[1]][pars[2]][pars[3]]}else{var curScrollPosition=gtm_datalayer.page.attributes.scrollPosition;if(curScrollPosition.length>2&&curScrollPosition.charAt(1)==='_'){curScrollPosition=curScrollPosition.charAt(0);curScrollPosition=1+ +curScrollPosition;params[key]=curScrollPosition+'_of_'+gtm_datalayer.page.attributes.scrollCount}}}else params[key]=gtm_datalayer[pars[1]][pars[2]][pars[3]]}else if(pars.length==5)params[key]=gtm_datalayer[pars[1]][pars[2]][pars[3]][pars[4]]}};related.queryStringParams=params};if(/Mobi|Android/i.test(navigator.userAgent)&&query_string_params_related_mobile.length!==0){var params=JSON.parse(query_string_params_related_mobile);related.queryStringParams=params};if(recommendation_type.length!==0)related.recommendationType=recommendation_type;if(style_classes.length!==0)related.styleClasses=style_classes;if(/Mobi|Android/i.test(navigator.userAgent)&&style_classes_mobile.length!==0)related.styleClasses=style_classes_mobile;if(subtitle_field.length!==0)if(subtitle_field=='false'){related.subtitleField=false}else related.subtitleField=subtitle_field;if(date_format.length!==0)related.dateFormat=date_format;Bibblio.initRelatedContent(related,{onRecommendationViewed:function(tracking){if(typeof dataLayer!=='undefined')dataLayer.push({event:'BIBBLIO_REL_CONTENT_VIEWED'})},onRecommendationClick:function(tracking){var clickedUrl=tracking.fields.url,clickedPath1=new URL(clickedUrl),clickedPath=clickedPath1.pathname,clickedActualDate=new Date(tracking.fields.datePublished),clickedFormattedDate="";if(clickedActualDate)clickedFormattedDate=clickedActualDate.toLocaleDateString("en-US",{month:'short'})+" "+clickedActualDate.toLocaleDateString("en-US",{day:'numeric'})+", "+clickedActualDate.toLocaleDateString("en-US",{year:'numeric'});if(typeof dataLayer!=='undefined')dataLayer.push({event:'BIBBLIO_REL_CONTENT_CLICKED',page:{attributes:{bibblioClickURL:clickedUrl,bibblioClickPath:clickedPath,bibblioClickPubDate:clickedFormattedDate}}})}});if(sponsored_catalogue_id){var sponsored={targetElementId:"bib_sponsored-content-"+current_nid,recommendationKey:recommendation_key,contentItemId:content_item_id,autoIngestion:false,catalogueIds:[sponsored_catalogue_id]};if(query_string_params_sponsored.length!==0){var params=JSON.parse(query_string_params_sponsored);for(var key in params){var param=params[key];if(param.indexOf('gtm_datalayer')>=0){var pars=param.split(".");if(pars.length==4){if(pars[3]=='scrollPosition'){var currElem='article.article-'+current_nid;if($(currElem).prev().length==0){params[key]=gtm_datalayer[pars[1]][pars[2]][pars[3]]}else{var curScrollPosition=gtm_datalayer.page.attributes.scrollPosition;if(curScrollPosition.length>2&&curScrollPosition.charAt(1)==='_'){curScrollPosition=curScrollPosition.charAt(0);curScrollPosition=1+ +curScrollPosition;params[key]=curScrollPosition+'_of_'+gtm_datalayer.page.attributes.scrollCount}}}else params[key]=gtm_datalayer[pars[1]][pars[2]][pars[3]]}else if(pars.length==5)params[key]=gtm_datalayer[pars[1]][pars[2]][pars[3]][pars[4]]}};sponsored.queryStringParams=params};if(/Mobi|Android/i.test(navigator.userAgent)&&query_string_params_sponsored_mobile.length!==0){var params=JSON.parse(query_string_params_sponsored_mobile);sponsored.queryStringParams=params};if(recommendation_type.length!==0)sponsored.recommendationType=recommendation_type;if(style_classes.length!==0)sponsored.styleClasses=style_classes;if(/Mobi|Android/i.test(navigator.userAgent)&&style_classes_mobile.length!==0)sponsored.styleClasses=style_classes_mobile;if(subtitle_field.length!==0)if(subtitle_field=='false'){sponsored.subtitleField=false}else sponsored.subtitleField=subtitle_field;if(date_format.length!==0)sponsored.dateFormat=date_format;Bibblio.initRelatedContent(sponsored,{onRecommendationViewed:function(tracking){if(typeof dataLayer!=='undefined')dataLayer.push({event:'BIBBLIO_SPONS_CONTENT_VIEWED'})},onRecommendationClick:function(tracking){var s_clickedUrl=tracking.fields.url,s_clickedPath1=new URL(s_clickedUrl),s_clickedPath=s_clickedPath1.pathname,s_clickedActualDate=new Date(tracking.fields.datePublished),s_clickedFormattedDate="";if(s_clickedActualDate)s_clickedFormattedDate=s_clickedActualDate.toLocaleDateString("en-US",{month:'short'})+" "+s_clickedActualDate.toLocaleDateString("en-US",{day:'numeric'})+", "+s_clickedActualDate.toLocaleDateString("en-US",{year:'numeric'});if(typeof dataLayer!=='undefined')dataLayer.push({event:'BIBBLIO_SPONS_CONTENT_CLICKED',page:{attributes:{bibblioClickURL:s_clickedUrl,bibblioClickPath:s_clickedPath,bibblioClickPubDate:s_clickedFormattedDate}}})}})}}else if(content_item_id.length==0){settings.penton_bibblio_api.recommendation_type='popular';var related={targetElementId:"bib_related-content-"+current_nid,recommendationKey:recommendation_key,autoIngestion:false,recommendationType:'popular'};if(query_string_params_related.length!==0){var params=JSON.parse(query_string_params_related);for(var key in params){var param=params[key];if(param.indexOf('gtm_datalayer')>=0){var pars=param.split(".");if(pars.length==4){if(pars[3]=='scrollPosition'){var currElem='article.article-'+current_nid;if($(currElem).prev().length==0){params[key]=gtm_datalayer[pars[1]][pars[2]][pars[3]]}else{var curScrollPosition=gtm_datalayer.page.attributes.scrollPosition;if(curScrollPosition.length>2&&curScrollPosition.charAt(1)==='_'){curScrollPosition=curScrollPosition.charAt(0);curScrollPosition=1+ +curScrollPosition;params[key]=curScrollPosition+'_of_'+gtm_datalayer.page.attributes.scrollCount}}}else params[key]=gtm_datalayer[pars[1]][pars[2]][pars[3]]}else if(pars.length==5)params[key]=gtm_datalayer[pars[1]][pars[2]][pars[3]][pars[4]]}};related.queryStringParams=params};if(/Mobi|Android/i.test(navigator.userAgent)&&query_string_params_related_mobile.length!==0){var params=JSON.parse(query_string_params_related_mobile);related.queryStringParams=params};if(style_classes.length!==0)related.styleClasses=style_classes;if(/Mobi|Android/i.test(navigator.userAgent)&&style_classes_mobile.length!==0)related.styleClasses=style_classes_mobile;if(subtitle_field.length!==0)if(subtitle_field=='false'){related.subtitleField=false}else related.subtitleField=subtitle_field;if(date_format.length!==0)related.dateFormat=date_format;Bibblio.initRelatedContent(related,{onRecommendationViewed:function(tracking){if(typeof dataLayer!=='undefined')dataLayer.push({event:'BIBBLIO_REL_CONTENT_VIEWED'})},onRecommendationClick:function(tracking){var clickedUrl=tracking.fields.url,clickedPath1=new URL(clickedUrl),clickedPath=clickedPath1.pathname,clickedActualDate=new Date(tracking.fields.datePublished),clickedFormattedDate="";if(clickedActualDate)clickedFormattedDate=clickedActualDate.toLocaleDateString("en-US",{month:'short'})+" "+clickedActualDate.toLocaleDateString("en-US",{day:'numeric'})+", "+clickedActualDate.toLocaleDateString("en-US",{year:'numeric'});if(typeof dataLayer!=='undefined')dataLayer.push({event:'BIBBLIO_REL_CONTENT_CLICKED',page:{attributes:{bibblioClickURL:clickedUrl,bibblioClickPath:clickedPath,bibblioClickPubDate:clickedFormattedDate}}})}})}}}}(jQuery));;/*})'"*/
(function($){'use strict'
...
var eloquaTrackingEnabled=false,eloquaSiteId='',eloquaSubdomain=''
