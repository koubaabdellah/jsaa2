;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="d14f9b15712c2b8c498a370f6272f996";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["1x4ODR6jd9nU"]={appId:"nt4L5NPJq1za",scope:{}};;CloudflareApps.installs["1x4ODR6jd9nU"].options={"blocks":[{"code":"\u003cscript\u003e\n (function(h,o,u,n,d) {\n   h=h[d]=h[d]||{q:[],onReady:function(c){h.q.push(c)}}\n   d=o.createElement(u);d.async=1;d.src=n\n   n=o.getElementsByTagName(u)[0];n.parentNode.insertBefore(d,n)\n})(window,document,'script','https://www.datadoghq-browser-agent.com/datadog-rum-v4.js','DD_RUM')\n  DD_RUM.onReady(function() {\n    DD_RUM.init({\n      clientToken: 'pub0d08a3915934c8a2ed8d6d02f634e557',\n      applicationId: '138cc92d-6d9f-443e-b698-612d53e47296',\n      site: 'datadoghq.eu',\n      service: 'mlb-cf',\n      env: 'production',\n      version: '1.0.1',\n      sampleRate: 10,\n      premiumSampleRate: 0,\n      trackInteractions: false\n    })\n\n    if (window.mlbOkta) {\n      var idToken = window.mlbOkta.getToken('id_token');\n      var clientId = null;\n  \n      if (idToken \u0026\u0026 idToken.claims) {\n          clientId = idToken.claims.sub;\n      }\n    \n      if (clientId) {\n          DD_RUM.setUser({ id: clientId });\n      }\n    }\n  })\n\u003c/script\u003e","location":{"method":"append","selector":"head"}},{"code":"","location":{"method":"append","selector":"body"}}]};;CloudflareApps.installs["1x4ODR6jd9nU"].selectors={"blocks[0].location.selector":"head","blocks[1].location.selector":"body"};;if(CloudflareApps.matchPage(CloudflareApps.installs['1x4ODR6jd9nU'].URLPatterns)){(function(){'use strict'
if(!document.addEventListener)return
var options=CloudflareApps.installs['1x4ODR6jd9nU'].options
var elements={}
var prevElements={}
...
window.CloudflareApps.installs['1x4ODR6jd9nU'].scope={setOptions:function(nextOptions){options=nextOptions
updateElements()}}}())}